...
//           <span className="font-bold text-xl text-black">THEKAFE.ai</span>
//         </div>
//         <div>
//           <button className="text-sm text-gray-700 mr-4">Login</button>
//           <button className="bg-[#f26f4d] text-white px-4 py-2 rounded-md">
//             Sign up
//           </button>
//         </div>
//       </header>
...
//           Discover more than <span className="text-[#f26f4d]">4000+ Jobs</span>
//         </h1>
