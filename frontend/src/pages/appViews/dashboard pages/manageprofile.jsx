...
//             <div>
//               <label className="block text-lg font-medium mb-1" htmlFor="full-name">Full name</label>
//               <input
//                 id="full-name"
//                 type="text"
//                 placeholder="Eg. LeBron James"
//                 className="w-full px-3 py-2 border border-gray-300 rounded-md"
//               />
//             </div>
//             <div>
//               <label className="block text-lg font-medium mb-1" htmlFor="email">Email address</label>
//               <input
//                 id="email"
//                 type="email"
...
//             </div>
//             <div>
//               <label className="block text-lg font-medium mb-1" htmlFor="country">Country</label>
//               <select
//                 id="country"
//                 className="w-full px-3 py-2 border border-gray-300 rounded-md"
//               >
...
//           <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//             <div>
//               <label className="block text-lg font-medium mb-1" htmlFor="job-title">Job title</label>
//               <input
//                 id="job-title"
//                 type="text"
...
//             </div>
//             <div>
//               <label className="block text-lg font-medium mb-1" htmlFor="experience">Work experience</label>
//               <input
//                 id="experience"
//                 type="text"
...
//             </div>
//             <div>
//               <label className="block text-lg font-medium mb-1" htmlFor="employment-type">Employment type</label>
//               <input
//                 id="employment-type"
//                 type="text"
...
//           </div>
//           <div
//             className={`border-2 border-dashed h-60 ${dragging ? "border-blue-500" : "border-gray-300"} p-8 rounded-lg text-center`}
...
//               <img
//                 src="/path/to/your/file-icon.svg" // Replace with your file icon path
//                 alt="File Icon"
//                 className="mb-2"
//               />
