...
//     navigate(`job/${index}`); // Redirect to the job details page with the job ID
//   };
...
//         ],
//       }));
//       setJobs(fetchedJobs); // Set jobs in state
//     };
...
const JobCard = ({ job, index }) => {
  ...
  const handleApplyClick = () => {
    ...
    // navigate(`/job/${index}`); Pass the job ID as a route parameter (relative to /dashboard)
    navigate(path); 
  };
